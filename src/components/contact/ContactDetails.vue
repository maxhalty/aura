    ...
    <v-row class="py-0 my-0">
      <v-col md="9" sm="6" cols="12" class="py-0 my-0">
        <p
          ...
          style="font-size:110%"
        >Queremos trabajar juntos para buscar las mejores maneras de utilizar la ludificacion en nuestros ambientes.</p>
        <p class="google-font">{{data.shortDescription}}</p>
        <p class="google-font mt-5">¿Preguntas? escribenos {{data.email}}</p>
